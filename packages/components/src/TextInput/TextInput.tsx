...
const inputShellVariants = cva(
  [
    'flex w-full items-center rounded-md border bg-surface-overlay text-foreground shadow-sm',
  ...
  ],
  {
    variants: {
      ...
      state: {
        ...
        error: 'border-danger-border focus-within:border-danger focus-within:ring-danger/20',
...
const affixVariants = cva('shrink-0 text-foreground-muted', {
  variants: {
    position: {
      prefix: 'mr-2',
      suffix: 'ml-2'
