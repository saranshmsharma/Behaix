...
const toastTitleVariants = cva('text-[var(--text-base)] font-[var(--font-semibold)] leading-[var(--leading-tight)]');
const toastDescriptionVariants = cva('mt-1 text-[var(--text-sm)] leading-[var(--leading-normal)] opacity-90');
  ...
  return (
    <div className={toastVariants({ variant })} role="status">
      ...
      <div>
        ...
        {toast.description ? <div className={toastDescriptionVariants()}>{toast.description}</div> : null}
...
export { closeVariants, toastDescriptionVariants, toastTitleVariants, toastVariants, viewportVariants };
