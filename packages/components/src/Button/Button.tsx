  ...
  ],
  {
    variants: {
      variant: {
        ...
        secondary: [
          'border border-border-subtle bg-surface-raised text-foreground shadow-sm',
        ...
        danger: [
          'border border-transparent bg-danger text-primary-fg shadow-[var(--shadow-sm)]',
          'hover:bg-danger-fg'
        ],
        link: [
          'h-auto border border-transparent bg-transparent p-0 text-primary underline-offset-4',
