...
const cardVariants = cva(
  [
    'rounded-[var(--radius-lg)] bg-[var(--color-surface-raised)] text-[var(--color-neutral-800)]',
  ...
  ],
  {
    variants: {
      variant: {
        ...
        outlined: 'border border-[var(--color-neutral-300)] shadow-none',
        elevated: 'border border-transparent shadow-[var(--shadow-md)]'
      },
      isInteractive: {
        true: 'cursor-pointer hover:-translate-y-0.5 hover:border-[var(--color-neutral-400)] hover:shadow-[var(--shadow-lg)] focus-within:ring-2 focus-within:ring-[var(--color-primary)] focus-within:ring-offset-2 focus-within:ring-offset-[var(--color-surface)]',
        false: ''
      }
    },
    defaultVariants: {
...
const cardFooterVariants = cva('flex items-center gap-3 border-t border-[var(--color-neutral-300)] p-6');
