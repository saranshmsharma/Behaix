...
const labelVariants = cva('text-[var(--text-base)] leading-[var(--leading-normal)] text-[var(--color-neutral-800)]');
              ...
              return (
                <div key={option.value} className={itemShellVariants()}>
                  ...
                  <div className="grid gap-0.5">
                    <label className={labelVariants()} htmlFor={itemId}>
                      {option.label}
                    </label>
                    {option.description ? <p className={descriptionVariants()}>{option.description}</p> : null}
                  </div>
                </div>
              );
            })}
...
export { descriptionVariants, groupVariants, indicatorVariants, itemShellVariants, labelVariants, radioItemVariants };
