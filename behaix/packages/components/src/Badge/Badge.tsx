...
const badgeVariants = cva(
  [
    'inline-flex max-w-full items-center gap-1.5 rounded-[var(--radius-full)] border font-[var(--font-medium)] leading-[var(--leading-tight)]',
    'transition-colors duration-[var(--duration-base)] ease-[var(--ease-default)] motion-reduce:transition-none'
  ],
  {
    variants: {
      variant: {
        default: 'border-[var(--color-neutral-300)] bg-[var(--color-neutral-100)] text-[var(--color-neutral-800)]',
        ...
        outline: 'border-[var(--color-neutral-300)] bg-transparent text-[var(--color-neutral-800)]'
      },
      size: {
